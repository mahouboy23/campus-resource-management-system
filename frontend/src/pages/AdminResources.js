...
} from "../services/resourceService"; // make sure updateResource exists
...
function AdminResources() {
  ...
  const [editingResource, setEditingResource] = useState(null); // track which resource is being edited
